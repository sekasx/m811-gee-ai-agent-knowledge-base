...
The MYD13A2 V6\.1 product provides two Vegetation Indices (VI): the Normalized
...
| --- | --- | --- | --- | --- | --- | --- |
| `NDVI` | None | \-2000 | 10000 | 0\.0001 | None | 16\-day NDVI average |
| `EVI` | None | \-2000 | 10000 | 0\.0001 | None | 16\-day EVI average |
...
| `DayOfYear` | Julian Day | 1 | 366 |  | None | Day of year VI pixel |
