...
| --- | --- | --- |
| domain | INT | Domain of the image (1 or 2\). Each domain is a 1000km x  1000km square which changes over time. Domain 1 defaults to the East  Coast of the United States; domain 2 defaults to the the Midwest region  of the United States. |
