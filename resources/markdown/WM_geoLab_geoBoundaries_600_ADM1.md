...
`ee.FeatureCollection("WM/geoLab/geoBoundaries/600/ADM1")` 
[open\_in\_new](https://code.earthengine.google.com/?scriptPath=Examples:Datasets/WM/WM_geoLab_geoBoundaries_600_ADM1)
...
`ui.Map.FeatureViewLayer("WM/geoLab/geoBoundaries/600/ADM1_FeatureView")` 
...
[geoBoundaries: Political administrative boundaries at District level (ADM1\), v6\.0\.0](/earth-engine/datasets/catalog/WM_geoLab_geoBoundaries_600_ADM1)
