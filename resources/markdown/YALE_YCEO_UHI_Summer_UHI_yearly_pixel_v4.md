...
[open\_in\_new](https://code.earthengine.google.com/?scriptPath=Examples:Datasets/YALE/YALE_YCEO_UHI_Summer_UHI_yearly_pixel_v4)
...
[YCEO Surface Urban Heat Islands: Pixel\-Level Composites of Yearly Summertime Daytime and Nighttime Intensity](/earth-engine/datasets/catalog/YALE_YCEO_UHI_Summer_UHI_yearly_pixel_v4)
...
This dataset contains annual, summertime, and wintertime surface urban heat island (SUHI) intensities for day and night for over 10,000 urban clusters throughout the world. The dataset was created using the MODIS 8\-day TERRA and AQUA land surface temperature (LST) products, the Landscan urban extent database, the Global Multi\-resolution Terrain …
 ...
 YALE/YCEO/UHI/Summer\_UHI\_yearly\_pixel/v4,
